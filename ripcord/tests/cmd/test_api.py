...
from ripcord.tests import utils
...
class TestCase(test.TestCase):
    def setUp(self):
        ...
        self.tempfile = utils.write_to_tempfile(
            content=content, prefix='ripcord', suffix='.conf')
        self.subp = subprocess.Popen([
            'ripcord-api', "--config-file=%s" % self.tempfile])
