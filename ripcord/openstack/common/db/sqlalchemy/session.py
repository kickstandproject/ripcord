...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/ripcord/sqlite.db",
        sqlite_db="/var/lib/ripcord/sqlite.db")
...
from ripcord.openstack.common.db import exception
from ripcord.openstack.common.gettextutils import _  # noqa
from ripcord.openstack.common import log as logging
from ripcord.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='ripcord.sqlite',
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside ripcord
            index = file.rfind('ripcord')
            if index == -1:
                continue
