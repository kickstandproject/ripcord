...
from ripcord.openstack.common import eventlet_backdoor
...
from ripcord.openstack.common import threadgroup


rpc = importutils.try_import('ripcord.openstack.common.rpc')
CONF = cfg.CONF
